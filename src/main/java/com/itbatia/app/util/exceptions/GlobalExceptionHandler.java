...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleException(AccessDeniedException e) {
        ErrorResponse errorResponse = new ErrorResponse("Access is denied! You - My!");
        return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
    }
//    @ExceptionHandler
//    private <T extends AccessDeniedException> ResponseEntity<ErrorResponse> handleException(T e) {
//        ErrorResponse errorResponse = new ErrorResponse(e.getMessage() + ". Access is denied");
//        return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
//    }
}
